...
const HTML_MAP = {
  ...
  'asthma': 'asthma-biomarkers.html',
  'type-2-diabetes': 'type-2-diabetes-biomarkers.html',
  'type-1-diabetes': 'type-1-diabetes-biomarkers.html',
  'hypertension': 'hypertension-biomarkers.html',
  'chronic-kidney-disease': 'chronic-kidney-disease-biomarkers.html',
  'nafld-mash-metabolic-associated-steatohepatitis': 'nafld-mash-metabolic-associated-steatohepatitis-biomarkers.html',
  'atrial-fibrillation': 'atrial-fibrillation-biomarkers.html',
  'copd': 'copd-biomarkers.html',
  'osteoarthritis': 'osteoarthritis-biomarkers.html',
  'low-back-pain': 'low-back-pain-biomarkers.html',
  'rheumatoid-arthritis': 'rheumatoid-arthritis-biomarkers.html',
  'alzheimer-s-disease-and-other-dementias': 'alzheimer-s-disease-and-other-dementias-biomarkers.html',
  'multiple-sclerosis': 'multiple-sclerosis-biomarkers.html',
  'epilepsy': 'epilepsy-biomarkers.html',
  'migraine': 'migraine-biomarkers.html',
  'major-depressive-disorder': 'major-depressive-disorder-biomarkers.html',
  'inflammatory-bowel-disease-crohn-s-uc': 'inflammatory-bowel-disease-crohn-s-uc-biomarkers.html',
  'gerd-gastroesophageal-reflux-disease': 'gerd-gastroesophageal-reflux-disease-biomarkers.html',
  'hepatitis-c': 'hepatitis-c-biomarkers.html',
  'hypothyroidism': 'hypothyroidism-biomarkers.html',
};
...
function buildOne(slug) {
  ...
  atlas.page.canonical = `https://research.opensourcemed.info/${htmlFileName}`;
