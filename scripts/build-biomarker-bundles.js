...
const SLUGS = [
  'long-covid', 'pacvs', 'me-cfs', 'lyme', 'gulf-war-illness', 'asthma', 'type-2-diabetes',
  'type-1-diabetes', 'hypertension', 'chronic-kidney-disease',
  'nafld-mash-metabolic-associated-steatohepatitis', 'atrial-fibrillation', 'copd',
  'osteoarthritis', 'low-back-pain', 'rheumatoid-arthritis',
  'alzheimer-s-disease-and-other-dementias', 'multiple-sclerosis', 'epilepsy', 'migraine',
  'major-depressive-disorder', 'inflammatory-bowel-disease-crohn-s-uc',
  'gerd-gastroesophageal-reflux-disease', 'hepatitis-c', 'hypothyroidism',
];
...
function main() {
  ...
  const conditionCategories = JSON.parse(
    fs.readFileSync(path.join(ROOT, 'data', 'condition-categories.json'), 'utf8')
  );
  writeBundle('condition-categories.bundle.js', '__CONDITION_CATEGORIES__', conditionCategories);
