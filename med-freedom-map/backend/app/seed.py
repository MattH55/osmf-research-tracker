...
JURISDICTIONS = [
    ...
    {"id": "jur-th", "name": "Thailand", "type": JurisdictionType.COUNTRY, "country_code": "TH", "latitude": 15.9, "longitude": 100.9, "general_notes": "Medical tourism hub for stem cells, regenerative medicine, cosmetic procedures. Growing psilocybin retreat industry in Chiang Mai/Bangkok. Light regulatory oversight. Variable quality—from excellent Bangkok hospitals to unregulated clinics."},
    {"id": "jur-es", "name": "Spain", "type": JurisdictionType.COUNTRY, "country_code": "ES", "latitude": 40.5, "longitude": -3.7, "general_notes": "IVF with PGT widely available, less restrictive than many EU countries. Assisted dying legal since 2021 (Organic Law 3/2021). Growing psychedelic research. Good medical tourism infrastructure, especially Barcelona, Madrid."},
    {"id": "jur-tu", "name": "Turkey", "type": JurisdictionType.COUNTRY, "country_code": "TR", "latitude": 39.0, "longitude": 35.2, "general_notes": "Major medical tourism destination (Istanbul, Ankara). Stem cell therapies, hair transplants, cosmetic surgery at lower costs. Regulatory oversight variable. Currency advantage for Western patients (Turkish Lira devaluation)."},
    {"id": "jur-in", "name": "India", "type": JurisdictionType.COUNTRY, "country_code": "IN", "latitude": 20.6, "longitude": 78.9, "general_notes": "World's largest IVF/fertility tourism market. Stem cell clinics widespread (quality varies). Ayurvedic/traditional medicine integration. Extremely low costs (50-80% less than US). Regulatory oversight weak, high variability in clinic quality."},
    {"id": "jur-br", "name": "Brazil", "type": JurisdictionType.COUNTRY, "country_code": "BR", "latitude": -14.2, "longitude": -51.9, "general_notes": "Large stem cell and regenerative medicine market. Ayahuasca retreat industry (Amazon, São Paulo). Growing cosmetic tourism. Regulatory body ANVISA oversees but enforcement inconsistent."},
    {"id": "jur-cr", "name": "Costa Rica", "type": JurisdictionType.COUNTRY, "country_code": "CR", "latitude": 9.7, "longitude": -83.8, "general_notes": "Established medical tourism destination. Stem cell clinics, fertility treatments, cosmetic surgery. CIMA hospitals provide quality infrastructure. Psychedelic retreats growing (psilocybin decriminalized informally). Moderate regulatory oversight."},
    {"id": "jur-uae", "name": "United Arab Emirates (Dubai)", "type": JurisdictionType.COUNTRY, "country_code": "AE", "latitude": 24.5, "longitude": 54.4, "general_notes": "Luxury medical tourism hub. Cutting-edge regenerative medicine clinics. Stem cells, exosomes, high-dose micronutrient IVs. Extremely high prices. Regulatory oversight: DHA (Dubai Health Authority) high standards. Minimal psychedelic access."},
    {"id": "jur-kr", "name": "South Korea", "type": JurisdictionType.COUNTRY, "country_code": "KR", "latitude": 36.2, "longitude": 127.1, "general_notes": "Advanced biotech hub. Stem cell research leading globally. Placentophagy and placental-derived therapies popular. Anti-aging/longevity medicine trend. High regulatory standards in Seoul/major cities. Medical tourism growing."},
    {"id": "jur-gr", "name": "Greece", "type": JurisdictionType.COUNTRY, "country_code": "GR", "latitude": 39.1, "longitude": 21.8, "general_notes": "IVF tourism destination (PGT available, lower costs than Western EU). Mediterranean lifestyle health tourism. Emerging psychedelic research. Healthcare quality high, costs moderate vs. Central/Northern Europe."},
    {"id": "jur-be", "name": "Belgium", "type": JurisdictionType.COUNTRY, "country_code": "BE", "latitude": 50.5, "longitude": 4.5, "general_notes": "Euthanasia/assisted dying legal since 2002 (one of first). No age minimum (minors can access with parental consent). Psychedelic research hub (VUB Brussels). IVF widely available. High regulatory standards."},
    {"id": "jur-se", "name": "Sweden", "type": JurisdictionType.COUNTRY, "country_code": "SE", "latitude": 60.1, "longitude": 18.6, "general_notes": "Progressive healthcare system. Psychedelic research active (Karolinska). Some stem cell therapies available. Assisted dying debates ongoing but no legal framework yet. High healthcare standards, expensive."},
    {"id": "jur-jp", "name": "Japan", "type": JurisdictionType.COUNTRY, "country_code": "JP", "latitude": 36.2, "longitude": 138.2, "general_notes": "Advanced medical technology and biohacking culture. Stem cell research strong. Peptide therapies available. Regulatory framework restrictive (fewer regenerative medicine clinics than expected). Medical tourism less developed than Thailand/Korea."},
    {"id": "jur-sg", "name": "Singapore", "type": JurisdictionType.COUNTRY, "country_code": "SG", "latitude": 1.3, "longitude": 103.8, "general_notes": "Biomedical hub with highest regulatory standards in Asia. Stem cell/regenerative medicine research. Expensive but high quality. Limited psychedelic access. Strict drug laws."},
    {"id": "jur-cl", "name": "Chile", "type": JurisdictionType.COUNTRY, "country_code": "CL", "latitude": -35.7, "longitude": -71.5, "general_notes": "Most developed healthcare system in Latin America. IVF widely available. Growing stem cell tourism. Psilocybin decriminalization movements. Moderate regulatory oversight, good infrastructure in Santiago."},
    {"id": "jur-ar", "name": "Argentina", "type": JurisdictionType.COUNTRY, "country_code": "AR", "latitude": -38.4, "longitude": -63.6, "general_notes": "Buenos Aires: growing medical tourism destination. Fertility treatments, cosmetic surgery, stem cells. Currency advantage (peso devaluation). Moderate regulatory oversight. Quality variable by clinic."},
    {"id": "jur-za", "name": "South Africa", "type": JurisdictionType.COUNTRY, "country_code": "ZA", "latitude": -30.6, "longitude": 22.9, "general_notes": "Leading African biotech hub (Cape Town, Johannesburg). Stem cell clinics, fertility tourism. Regulatory oversight through SAHPRA (South African Health Products Regulatory Authority). Quality clinics available at lower cost than Western countries."},
    {"id": "jur-ph", "name": "Philippines", "type": JurisdictionType.COUNTRY, "country_code": "PH", "latitude": 12.9, "longitude": 121.8, "general_notes": "Emerging medical tourism destination. Stem cell clinics, fertility treatment. Lower costs than Thailand. Regulatory oversight weak (FDA equivalent has limited enforcement). Quality variable."},
    {"id": "jur-po", "name": "Poland", "type": JurisdictionType.COUNTRY, "country_code": "PL", "latitude": 51.9, "longitude": 19.1, "general_notes": "Growing medical tourism hub (Warsaw, Krakow). Fertility treatments, stem cells, regenerative medicine. EU medical standards but lower costs. Psychedelic research active. Good balance of cost/quality."},
    {"id": "jur-pt", "name": "Portugal", "type": JurisdictionType.COUNTRY, "country_code": "PT", "latitude": 39.4, "longitude": -8.2, "general_notes": "Decriminalized all drugs (2001 onward—consumption is 'disorderly conduct' not criminal). Growing psychedelic retreat/research centers. IVF tourism destination. Lisbon/Porto wellness tourism hub. Moderate costs, good infrastructure."},
    {"id": "jur-fr", "name": "France", "type": JurisdictionType.COUNTRY, "country_code": "FR", "latitude": 46.6, "longitude": 2.2, "general_notes": "Strong healthcare system. Some stem cell therapies via academic research. Assisted dying: recent debates, no legal framework yet. Psychedelic research growing (Paris, universities). High costs, excellent quality."},
]
